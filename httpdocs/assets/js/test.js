(function(){var testing = 1; window=testing = testing;/*!
...
App.GlobalEvents = new App.Events();/* Config
 *************************/
App.Config = (function() {
...
}($('#map-canvas')));App.Map.Actions = (function() {
...
App.inherits(App.Models.User, App.Models.Base);App.ViewModels.Navbar = function(container, controller) {
